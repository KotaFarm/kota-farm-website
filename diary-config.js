...
(function () {
    ...
    fetch(DIARY_CSV_URL)
        ...
        .catch(function (err) {
            ...
            window.DIARY_ENTRIES = [
                { date: 'May 27, 2026', _dateIso: '2026-05-27', title: 'Shade net rebuilt — stronger foundation', tag: 'infra', photo: 'diary/shade-net-rebuilt.jpeg', note: 'After the storm damaged the shade net nursery, we rebuilt it with stronger foundational material. The new structure is designed to hold up better against wind and weather.' },
